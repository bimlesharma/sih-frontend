...
//       try {
//         const response = await fetch("/category_specs.json"); // Adjust path if needed
...
//           <form
//             onSubmit={handleSubmit(onSubmit)}
//             className="bg-gray-100 flex flex-col lg:flex-row shadow gap-2 items-center justify-between rounded-3xl lg:rounded-3xl px-2 py-2 lg:w-auto mt-4 lg:mt-0"
//           >
//             <div className="w-full">
//               <input
//                 id="itemName"
...
//                 <p className="text-red-500 text-sm mt-1">{errors.specification.message}</p>
//               )}
//             </div>
...
//                     </a>
//                   </td>
//                   <td className="border border-gray-300 px-4 py-2">{result.vintage}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
...
//       setMultipleSpecs((prevSpecs) => [
//         ...prevSpecs,
//         { spec: specInput, value: specValueInput },
//       ]);
//       setSpecInput("");
//       setSpecValueInput("");
//     }
...
//     setMultipleSpecs((prevSpecs) => prevSpecs.filter((_, i) => i !== index));
//   };

//   const onSubmit = (data) => {
//     console.log("Specification Search Data:", { ...data, specifications: multipleSpecs });
//     setSearchQuery({ ...data, specifications: multipleSpecs });
//     setIsSearchSubmitted(true);
...
//         {/* Inputs for adding multiple specifications */}
  ...
  return (
    <div className="min-h-screen pt-20 flex flex-col items-center text-sm lg:pt-16 bg-white px-4 sm:px-8 md:px-16 lg:px-0">
      <div className="w-full items-center flex flex-col">
        ...
        {/* Dropdowns for selecting specifications */}
        <div className="flex gap-2 mt-4">
