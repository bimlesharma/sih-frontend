...
//   const onSubmit = (data) => {
//     console.log("Specification Search Data:", data);
...
//   return (
//     <div className="min-h-screen flex flex-col items-center bg-white px-4 sm:px-8 md:px-16 lg:px-0">
//       {/* <hr className="w-full border-gray-200" /> */}
//       <div className="  w-full">
//         <div className="flex flex-col lg:flex-row w-full justify-center gap-5  py-3 bg-yellow-40 lg:px-20">
//           <div className="text-lg font-bold h-14 shadow rounded-full gap-2 flex bg-gray-100 items-center w-full  lg:w-auto mx-auto px-2 sm:mx-0">
//             {/* <Image
//             src="/logo.png"
