    ...
    <footer className="bg-gray-800 text-white text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-gray-400">
              <li>
                Email:{" "}
                <a
                  href="mailto:contact.brahmabytes@gmail.com"
                  className="hover:text-gray-300"
                >
                  contact.brahmabytes@gmail.com
                </a>
              </li>
              <li>
                Phone:{" "}
                <a href="tel:+911234567890" className="hover:text-gray-300">
                  +91 1234567890
                </a>
              </li>
        ...
        <div className="mt-8 text-center text-sm text-gray-400">
          &copy; {new Date().getFullYear()} Team Brahma Bytes. All rights
          reserved.
        </div>
      </div>
    </footer>
